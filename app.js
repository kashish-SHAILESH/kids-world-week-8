...
var  gmae4add=document.getElementById("game4")
...
console.log(book3add);
console.log(book4add);
console.log(book5add);
console.log(book6add);

console.log(game1add);
console.log(game2add);
console.log(game3add);
console.log(gmae4add);

console.log(craft1add);
console.log(craft2add);
console.log(craft3add);
console.log(craft4add);
